...
import { isAutoGeneratedGuest } from '@/lib/algorithm';
...
export function GuestManagement() {
  ...
  // Filter out auto-generated guests from couple selection
  const availableForCouple = guests.filter((g) => !isInCouple(g.id) && !isAutoGeneratedGuest(g));

  // Sort guests: non-generated first, then by firstName
...
function GuestRow({
  ...
  // Filter out auto-generated guests from exclusions list
  const otherGuests = allGuests.filter((g) => g.id !== guest.id && !isAutoGeneratedGuest(g));
